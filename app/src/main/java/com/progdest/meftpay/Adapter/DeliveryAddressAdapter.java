...
public class DeliveryAddressAdapter extends RecyclerView.Adapter<DeliveryAddressAdapter.ViewHolder> {
    ...
    public DeliveryAddressAdapter(ArrayList<UserAddressmodel> addresses, Context context) {
        this.addresses = addresses;
        this.context = context;
    }
    @Override
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.card_address, viewGroup, false);
